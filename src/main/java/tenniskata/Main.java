...
class TennisGame {
    ...
    public String getScore() {
        // 점수 분류
        /*
        case1. m_score1 == m_score2
        case2. m_score1 >= 4 || m_score2 >= 4
        case3. else
         */
        ...
        return warmingUpStage();
    }

    private String deuceStage() {
        switch (m_score1)
        {
            case 0:
                return  "Love-All";
    ...
    private String warmingUpStage() {
        return namingScore(m_score1) + '-' + namingScore(m_score2);
    }

    private static String namingScore(int tempScore) {
        switch(tempScore)
        {
            case 0:
                return "Love";
